        ...
        for k, lines in groups.items():
            ...
            for asset, qty in base_out.items():
                ...
                mirror_table.append(Trade(
                    ...
                    quantity=qty, value_eur=v, fee_eur=total_fee_eur,  # Fee asignado íntegramente a la venta
            ...
            for asset, qty in base_in.items():
                ...
                mirror_table.append(Trade(
                    ...
                    quantity=qty, value_eur=c, fee_eur=Decimal('0'),  # Fee=0 en compra para evitar doble conteo en FIFO
                    asset_type="crypto", notes=f"History | Group: {k}"
                ))

...
class LossCarryForward:
    ...
    @classmethod
    def from_input(cls, data: Union[Decimal, Dict[int, Decimal], 'LossCarryForward'], current_year: int) -> 'LossCarryForward':
...
class OtherIncome:
    ...
    def __post_init__(self):
        ...
        if isinstance(self.gain_loss_eur, float) or isinstance(self.porcentaje_titularidad, float) or isinstance(self.withholding_eur, float):

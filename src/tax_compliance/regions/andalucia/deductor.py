...
class AndalusiaDeductor:
    ...
    def calculate_all(cls, profile: TaxpayerProfile, base_general: Decimal, base_ahorro: Decimal) -> dict[str, Decimal]:
        ...
        limite_bi_and11 = cls.LIMITE_BI_CONJUNTA if getattr(profile, 'joint_declaration', False) else cls.LIMITE_BI_INDIVIDUAL
        ...
        limite_bi_gral = cls.LIMITE_BI_CONJUNTA if getattr(profile, 'joint_declaration', False) else cls.LIMITE_BI_INDIVIDUAL

...
def test_and01_alquiler_habitual():
    profile = ProfileBuilder.from_dict(
        dict(age=30, disability_grade=0, is_rent_habitual=True, rent_paid_annual_eur=Decimal("10000"))
    )
    ...
    profile_dis = ProfileBuilder.from_dict(
        dict(age=30, disability_grade=33, is_rent_habitual=True, rent_paid_annual_eur=Decimal("10000"))
    )
...
def test_and03_nacimiento_universal_multiple():
    profile_simple = ProfileBuilder.from_dict(dict(age=40, birth_count_current_year=1))
    ...
    profile_multiple = ProfileBuilder.from_dict(dict(age=40, birth_count_current_year=2))

    ded_region_mult = AndalusiaRegion.get_quota_deductions(
        profile_multiple, Decimal("90000"), Decimal("0"), Decimal("1000")
    )
...
def test_and05_celiaco_universal():
    profile = ProfileBuilder.from_dict(dict(age=35, is_celiac=True))
...
def test_and06_gastos_veterinarios():
    profile = ProfileBuilder.from_dict(dict(age=30, vet_expenses_eur=Decimal("300")))
    ...
    profile_capped = ProfileBuilder.from_dict(dict(age=30, vet_expenses_eur=Decimal("500")))

    ded_region_cap = AndalusiaRegion.get_quota_deductions(
        profile_capped, Decimal("40000"), Decimal("0"), Decimal("1000")
    )
...
def test_and07_ejercicio_fisico():
    profile = ProfileBuilder.from_dict(dict(age=30, gym_expenses_eur=Decimal("1000")))
...
def test_and09_monoparental_con_ascendientes():
    profile = ProfileBuilder.from_dict(dict(age=40, is_monoparental=True, descendants_count=1, ascendants_over75=0))
    ...
    profile_asc = ProfileBuilder.from_dict(dict(age=40, is_monoparental=True, descendants_count=1, ascendants_over75=2))
...
def test_and11_familia_numerosa_general_y_especial():
    profile_gen = ProfileBuilder.from_dict(
        dict(age=40, is_large_family=True, descendants_count=3, is_large_family_special=False)
    )
    ...
    profile_spec = ProfileBuilder.from_dict(
        dict(age=40, is_large_family=True, descendants_count=3, is_large_family_special=True)
    )

    ded_region_spec = AndalusiaRegion.get_quota_deductions(
        profile_spec, Decimal("20000"), Decimal("0"), Decimal("1000")
    )
...
def test_incompatibilidad_and03_vs_and11():
    profile_spec_birth = ProfileBuilder.from_dict(
        dict(
            age=40, birth_count_current_year=1, is_large_family=True, descendants_count=3, is_large_family_special=True
        )
    )

    ded_region = AndalusiaRegion.get_quota_deductions(
        profile_spec_birth, Decimal("20000"), Decimal("0"), Decimal("1000")
    )
    ...
    profile_mult_birth = ProfileBuilder.from_dict(
        dict(
            age=40, birth_count_current_year=2, is_large_family=True, descendants_count=3, is_large_family_special=False
        )
    )

    ded_region_mult = AndalusiaRegion.get_quota_deductions(
        profile_mult_birth, Decimal("20000"), Decimal("0"), Decimal("1000")
    )

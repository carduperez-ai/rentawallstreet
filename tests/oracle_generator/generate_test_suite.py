...
_NIF_POOL = [
    "12345678Z", "54357930W", "87654321X", "22222222J", "33333333P",
    "44444444R", "55555555K", "66666666Q", "77777777V", "99999999R",
    "11111111H", "22222222J", "33333333P", "44444444R", "55555555K",
    "66666666Q", "77777777V", "88888888Y", "99999999R", "12312312S"
]
_nif_counter = 0
...
def generate_full_matrix() -> list:
    ...
    declarant_types = [
        ...
        ("CAS-CON", {"marital_status": "married", "joint_declaration": True, "spouse_income": 15000.0}, ["Casado", "Conjunta"]),
        ("MONO", {"marital_status": "divorced", "is_monoparental": True, "joint_declaration": True, "descendants": 2}, ["Monoparental", "Conjunta"])
    ]
    ...
    for decl_code, decl_params, decl_tags in declarant_types:
        for s in income_levels:
            ...
            p_rent["rentals"] = [{"property_id": "V1", "gross_income": rent_val, "deductible_expenses": 2000.0, "reduction_habitual": True}]
            cases.append(format_case(

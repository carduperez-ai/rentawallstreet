...
def test_cyl_num_familia_numerosa():
    ...
    profile_disc = ProfileBuilder.from_dict(
        dict(
            age=35,
            region="castilla_leon",
            joint_declaration=False,
...
def test_cyl02_nacimiento_adopcion():
    ...
    profile_rur_disc = ProfileBuilder.from_dict(
        dict(
            age=30,
            region="castilla_leon",
            joint_declaration=False,
...
def test_cyl01_alquiler_joven():
    ...
    profile_urb = ProfileBuilder.from_dict(
        dict(
            age=34,
            region="castilla_leon",
            joint_declaration=False,
    ...
    profile_rur = ProfileBuilder.from_dict(
        dict(
            age=34,
            region="castilla_leon",
            joint_declaration=False,

...
def test_canarias_donaciones():
    ...
    profile = ProfileBuilder.from_dict(dict(region='canarias', 
        age=40,
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('20000'), Decimal('0'), Decimal('1000'))}
...
def test_canarias_estudios():
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('30000'), Decimal('0'), Decimal('5000'))}
    ...
    res_high = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('50000'), Decimal('0'), Decimal('5000'))}
...
def test_canarias_vivienda_15_cap():
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('20000'), Decimal('0'), Decimal('10000'))}
...
def test_canarias_alquileres_and_dacion():
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('20000'), Decimal('0'), Decimal('3000'))}
...
def test_canarias_incompatibilidades_arrendador():
    ...
    profile_insur_wins = ProfileBuilder.from_dict(dict(region='canarias', 
        age=40,
    ...
    res_insur = {d.box_id: d.value for d in CanariasDeductor.calculate(profile_insur_wins, Decimal('20000'), Decimal('0'), Decimal('1000'))}
...
def test_canarias_desempleado_enfermedad_etc():
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('19500'), Decimal('0'), Decimal('1000'))}
...
def test_canarias_nacimiento_and_personal():
    ...
    res = {d.box_id: d.value for d in CanariasDeductor.calculate(profile, Decimal('20000'), Decimal('0'), Decimal('2000'))}

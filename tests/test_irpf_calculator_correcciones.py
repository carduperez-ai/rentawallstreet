...
def test_eficiencia_energetica_limite_base():
    ...
    profile = ProfileBuilder.from_dict(
        dict(age=40, energy_efficiency_investment_eur=Decimal("10000"), energy_efficiency_type=20)
    )
...
def test_donativos_recurrencia_fidelizacion():
    ...
    profile_normal = ProfileBuilder.from_dict(dict(age=40, donations_eur=Decimal("1000"), donations_fidelized=False))
    ...
    profile_fidel = ProfileBuilder.from_dict(dict(age=40, donations_eur=Decimal("1000"), donations_fidelized=True))
...
def test_la_rioja_internet_access_youth():
    ...
    profile = ProfileBuilder.from_dict(
        dict(age=30, internet_access_expenses_eur=Decimal("400"), joint_declaration=False)
    )
    work1 = WorkIncome(
        retribuciones_dinerarias=Decimal("20000"), retenciones=Decimal("0"), gastos_deducibles=Decimal("0")
    )
    ...
    work2 = WorkIncome(
        retribuciones_dinerarias=Decimal("22000"), retenciones=Decimal("0"), gastos_deducibles=Decimal("0")
    )
...
def test_interbloqueo_foral_euskadi_navarra():
    ...
    with pytest.raises(
        NotImplementedError,
        match="El sistema no dispone de soporte para la liquidación del IRPF bajo regímenes forales especiales.",
    ):
...
def test_exclusion_cfds_wash_sales():
    ...
    events = [
        TaxEvent(
            ...
            acquisition_date=datetime(2025, 10, 1),
            acquisition_cost_eur=Decimal("1500"),
            sale_proceeds_eur=Decimal("1400"),
...
def test_doble_imposicion_con_tme_ahorro():
    ...
    work = WorkIncome(
        retribuciones_dinerarias=Decimal("100000"), retenciones=Decimal("30000"), gastos_deducibles=Decimal("5000")
    )
    profile = ProfileBuilder.from_dict(dict(age=40))

    calc = IRPFCalculator(
        dividends=[div], crypto_events=[], stock_events=[], work=work, profile=profile, region="madrid"
    )
    res = calc.calculate().raw_summary
    # TME_ahorro = 19%
...
def test_airdrop_hardfork_base_general():
    ...
    profile = ProfileBuilder.from_dict(dict(age=40))
    calc = IRPFCalculator(
        dividends=[], crypto_events=[event_airdrop], stock_events=[], profile=profile, region="madrid"
    )
...
def test_alquiler_habitual_ley_vivienda():
    ...
    calc_new_def = IRPFCalculator(
        dividends=[], crypto_events=[], stock_events=[], rental_income=[r_new_def], region="madrid"
    )
    ...
    calc_new_90 = IRPFCalculator(
        dividends=[], crypto_events=[], stock_events=[], rental_income=[r_new_90], region="madrid"
    )
...
def test_cobro_aplazado_criterio_caja():
    ...
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], other_pyg=[pyg], region="madrid")
    res = calc.calculate().raw_summary
...
def test_murcia_guarderia_incompatibilidad():
    ...
    work = WorkIncome(
        retribuciones_dinerarias=Decimal("20000"), retenciones=Decimal("1000"), gastos_deducibles=Decimal("500")
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], work=work, profile=profile, region="murcia")
    res = calc.calculate().raw_summary
...
def test_alquiler_transitorio_vs_regional_solapamiento():
    ...
    work = WorkIncome(
        retribuciones_dinerarias=Decimal("22000"), retenciones=Decimal("1000"), gastos_deducibles=Decimal("500")
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], work=work, profile=profile, region="madrid")
    res = calc.calculate().raw_summary
...
def test_eficiencia_energetica_limite_plurianual():
    ...
    work = WorkIncome(
        retribuciones_dinerarias=Decimal("50000"), retenciones=Decimal("0"), gastos_deducibles=Decimal("0")
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], profile=profile, region="madrid", work=work)
    res = calc.calculate().raw_summary
...
def test_mortgage_pre2013_date_validation():
    ...
    profile_post = ProfileBuilder.from_dict(
        dict(age=30, mortgage_pre2013=True, mortgage_paid_eur=Decimal("5000"), mortgage_acquisition_date="2013-05-15")
    )
    ...
    profile_pre = ProfileBuilder.from_dict(
        dict(age=30, mortgage_pre2013=True, mortgage_paid_eur=Decimal("5000"), mortgage_acquisition_date="2012-10-10")
    )
...
def test_startup_investment_rules():
    ...
    profile_pct = ProfileBuilder.from_dict(
        dict(
            age=30,
    ...
    profile_age = ProfileBuilder.from_dict(
        dict(
            age=30,
            startup_investment_eur=Decimal("10000"),
    ...
    profile_emerg = ProfileBuilder.from_dict(
        dict(
            age=30,
            startup_investment_eur=Decimal("10000"),
            startup_ownership_pct=Decimal("0.10"),
...
def test_donations_new_15_percent_limit():
    ...
    """
    work = WorkIncome(
        retribuciones_dinerarias=Decimal("30000"), retenciones=Decimal("0"), gastos_deducibles=Decimal("0")
    )
    profile = ProfileBuilder.from_dict(dict(age=30, donations_eur=Decimal("2000"), donations_fidelized=True))
...
def test_differential_deductions_monthly_precision():
    ...
    profile_limit = ProfileBuilder.from_dict(
        dict(
            age=30,
            children_under_3=1,
            is_working_mother=True,
            maternity_months={1: Decimal("50"), 2: Decimal("120"), 3: Decimal("80")},
        )
    )
    ...
    profile_exempt = ProfileBuilder.from_dict(
        dict(
            age=30,
            children_under_3=1,
            is_working_mother=True,
...
def test_minimo_autonomico_madrid_2025():
    ...
    """
    p = ProfileBuilder.from_dict(
        dict(age=40, region="madrid", descendants_count=1, children_under_3=1, disability_grade=0)
    )
...
def test_minimo_autonomico_galicia_2025():
    ...
    """
    p = ProfileBuilder.from_dict(
        dict(age=40, region="galicia", descendants_count=1, children_under_3=1, disability_grade=0)
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], profile=p)
...
def test_minimo_autonomico_baleares_2025():
    ...
    """
    p = ProfileBuilder.from_dict(
        dict(age=40, region="baleares", descendants_count=2, children_under_3=0, disability_grade=0)
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], profile=p)
...
def test_minimo_autonomico_valenciana_2025():
    ...
    """
    p = ProfileBuilder.from_dict(
        dict(age=40, region="valenciana", descendants_count=1, children_under_3=1, disability_grade=0)
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], profile=p)
...
def test_minimo_autonomico_la_rioja_2025():
    ...
    """
    p = ProfileBuilder.from_dict(
        dict(age=40, region="la_rioja", descendants_count=0, disability_grade=70, disability_mobility_reduced=True)
    )
    calc = IRPFCalculator(dividends=[], crypto_events=[], stock_events=[], profile=p)

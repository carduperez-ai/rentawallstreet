...
class _StockEvent:
    ...
    def __init__(self, asset, asset_type, gain_loss_eur, sale_proceeds_eur,
                 acquisition_cost_eur, isin="US0231351067", ticker="AMZN",
                 platform="DeGiro", is_wash_sale=False,
                 buy_fee_eur=Decimal('0'), sell_fee_eur=Decimal('0'), date=None):
        self.asset = asset
...
REQUIRED_KEYS = {
    "work_bruto", "work_gastos", "work_retenciones", "work_neto",
    "rental_bruto", "rental_gastos", "rental_neto",
    "other_bg",
    "base_general", "base_ahorro",
    "capital_yield_total",
    "dividendos_brutos", "retencion_dividendos",
    "deduccion_doble_imposicion",
    "cuota_liquida",
    "deducciones_ccaa",
    "resultado", "resultado_label",
    "remanente_gpp_futuro", "remanente_rcm_futuro",
    "cripto_aeat", "acciones_aeat", "iic_aeat", "otros_aeat",
    "inmuebles_aeat",
    "crypto_gain_loss",
    "custody_fees",
    "dividend_details",
...
def test_crypto_gain_loss_counts_only_crypto_events():
    ...
    stock_ev = _StockEvent("AMZN", "stock", Decimal('300'), sale_proceeds_eur=Decimal('1300'), acquisition_cost_eur=Decimal('1000'))
...
def test_group_aeat_events_stock_uses_isin_as_key():
    ...
    stock_ev = _StockEvent("Amazon.com Inc", "stock", Decimal('100'), sale_proceeds_eur=Decimal('1100'), acquisition_cost_eur=Decimal('1000'))
...
def test_custody_fees_accumulated():
    ...
    fee = Dividend(
        date=datetime(2025, 1, 1), platform="DeGiro", asset="CUSTODY",
        isin="", gross_eur=Decimal('0'),
        withholding_foreign_eur=Decimal('0'),
        withholding_spain_eur=Decimal('0'),
        type='fee', custody_fee_eur=Decimal('12.50'),
    )

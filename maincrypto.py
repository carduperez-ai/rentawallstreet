...
from src.reporting.stock_excel_generator import generate_stock_audit_excel
...
def calculate():
    try:
        ...
        from src.ingestion.binance_reader import BinanceIngestor, BinancePDFReader
        ...
        all_trades = []; all_dividends = []; all_warnings = []

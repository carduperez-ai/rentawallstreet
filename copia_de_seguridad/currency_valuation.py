    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=10) as resp:
            ...
            if "rates" in data:
                ...
                print(f"  [OK] Historial de divisas cargado.")
...
def usd_to_eur(usd_amount: Decimal, date_obj: datetime) -> Decimal:
    """
    Convierte una cantidad en USD a EUR utilizando el tipo de cambio oficial
    del BCE para la fecha especificada.
    """
...
class MarketPriceOracle:
    ...
    def get_price_eur(self, asset: str, date_obj: datetime) -> Optional[Decimal]:
        ...
        # 1. Identidad EUR
        if asset == 'EUR': return Decimal('1.0')
    ...
    def _fetch_external_price(self, asset: str, date_obj: datetime) -> Optional[Decimal]:
        ...
        try:
            ...
            try:
                ...
                url_usdt = f"https://api.binance.com/api/v3/klines?symbol={symbol_usdt}&interval=1d&startTime={ts_ms}&limit=1"
            ...
            print(f"  [!] ERROR CRÍTICO: Ninguna fuente (Binance/CryptoCompare) tiene datos para {asset} el {date_obj.strftime('%Y-%m-%d')}.")
            return None

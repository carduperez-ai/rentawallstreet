...
regions = ['asturias', 'baleares', 'canarias', 'cantabria', 'castilla_la_mancha', 'castilla_leon', 'cataluna', 'ceuta', 'extremadura', 'galicia', 'la_rioja', 'madrid', 'melilla', 'murcia', 'valenciana']
for r in regions:
    reconstruct_scale(r)
